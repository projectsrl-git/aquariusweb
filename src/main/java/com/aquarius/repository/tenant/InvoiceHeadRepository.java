...
public interface InvoiceHeadRepository extends JpaRepository<InvoiceHead, String> {
    ...
    @Query("""
        ...
        """)
    Page<InvoiceHead> search(@Param("soc") String soc, @Param("anno") String anno,
