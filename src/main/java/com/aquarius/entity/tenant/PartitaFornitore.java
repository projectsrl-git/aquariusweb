...
/**
 * Partita aperta fornitore — riga della tabella {@code PART_FOR} (legacy, READ-ONLY).
...
public class PartitaFornitore {
    ...
    /** Codice anagrafica (fornitore). Nota: in PART_FOR la colonna e' PAR_CODCLI. */
